<?php if (isset($flash['errors']) && is_array($flash['errors'])): ?>
    <div class="mb-6">
...
<?php if (isset($flash['status']) && $flash['status']): ?>
    <div class="mb-6" x-data="{ show: true }" x-show="show" @click.outside="show = false">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-green-800">
                        <?php echo htmlspecialchars($flash['status']); ?>
                    </p>
                </div>
...
<?php if (isset($flash['warning']) && $flash['warning']): ?>
    <div class="mb-6" x-data="{ show: true }" x-show="show" @click.outside="show = false">
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-yellow-800">
                        <?php echo htmlspecialchars($flash['warning']); ?>
                    </p>
                </div>
